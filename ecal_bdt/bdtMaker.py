...
if __name__ == "__main__":
    ...
    parser.add_option('--bkg_file', dest='bkg_file', default='/nfs/slac/g/ldmx/data/mc/cal_bdt_data/bkg/recon-train/*.root', help='name of background file')
    parser.add_option('--sig_file', dest='sig_file', default='/nfs/slac/g/ldmx/data/mc/cal_bdt_data/sig/recon-train/*.root', help='name of signal file')
