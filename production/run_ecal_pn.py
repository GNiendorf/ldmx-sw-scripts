...
def generate_macro(output_path):
    ...
    macro_file.write('/ldmx/biasing/process photonNuclear\n')
    ...
    macro_file.write('/ldmx/biasing/xsec/process photonNuclear\n')
    macro_file.write('/ldmx/biasing/xsec/threshold 2500\n')
    macro_file.write('/ldmx/biasing/xsec/factor 1000\n')
    ...
    macro_file.write('/ldmx/plugins/TrackFilterPlugin/process photonNuclear true\n')
    macro_file.write('/ldmx/plugins/TrackFilterPlugin/region CalorimeterRegion true \n')
    macro_file.write('/ldmx/plugins/TrackFilterPlugin/create pnFilter\n')
